...
grid = {'lr': [0.1, 0.2], 'dropout': [0.4, 0.5]}

def search(params, tr_batch_size=6, val_batch_size=16):
	lr, dropout = params
    ...
    model.supervised_train_data(xtr,ytr,xval,yval,batch_size=6,epochs=10,save=os.path.join('models',name), lr=lr, warmup=True)
